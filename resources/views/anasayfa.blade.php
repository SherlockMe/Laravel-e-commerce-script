            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="list-group categories">
                       ...
                       <a href="{{ route('kategori',$kategori->slug) }}" class="list-group-item"><i class="fa fa-angle-right"></i> {{ $kategori->kategori_adi }} </a>
                       @endforeach
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item {{ $index == 0 ? 'active' : '' }}">
                            <img src="http://via.placeholder.com/640x400?text=ÜrünResmi" alt="...">
                ...
                <div class="panel panel-default" id="sidebar-product">
                    ...
                    <div class="panel-body">
                        <a href="{{ route('urun',$urun_gunun_firsati->slug) }}">
                            <img src="http://via.placeholder.com/400x480?text=ÜrünResmi" class="img-responsive">
